...
public class GatewayApiController {
    ...
    public Result<List<ApiDefinitionEntity>> queryApis(HttpServletRequest request, String app, String ip,
                                                       Integer port) {
    ...
    public Result<ApiDefinitionEntity> addApi(HttpServletRequest request, @RequestBody AddApiReqVo reqVo) {
        ...
        for (ApiPredicateItemVo predicateItem : predicateItems) {
            ...
            if (!Arrays.asList(URL_MATCH_STRATEGY_EXACT, URL_MATCH_STRATEGY_PREFIX, URL_MATCH_STRATEGY_REGEX).contains(
                    matchStrategy)) {
