...
public class GatewayFlowRuleController {
    ...
    public Result<List<GatewayFlowRuleEntity>> queryFlowRules(HttpServletRequest request, String app, String ip,
                                                              Integer port) {
    ...
    public Result<GatewayFlowRuleEntity> addFlowRule(HttpServletRequest request, @RequestBody AddFlowRuleReqVo reqVo) {
        ...
        if (!Arrays.asList(INTERVAL_UNIT_SECOND, INTERVAL_UNIT_MINUTE, INTERVAL_UNIT_HOUR, INTERVAL_UNIT_DAY).contains(
                intervalUnit)) {
    ...
    public Result<GatewayFlowRuleEntity> updateFlowRule(HttpServletRequest request,
